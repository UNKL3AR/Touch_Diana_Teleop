...
{
  new (message_memory) sri_interface::msg::OmniFeedback(_init);
}

void OmniFeedback_fini_function(void * message_memory)
{
  auto typed_message = static_cast<sri_interface::msg::OmniFeedback *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember OmniFeedback_message_member_array[2] = {
  {
    ...
    offsetof(sri_interface::msg::OmniFeedback, force),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(sri_interface::msg::OmniFeedback, position),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers OmniFeedback_message_members = {
  "sri_interface::msg",  // message namespace
  "OmniFeedback",  // message name
  2,  // number of fields
  sizeof(sri_interface::msg::OmniFeedback),
...
{
  return &::sri_interface::msg::rosidl_typesupport_introspection_cpp::OmniFeedback_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sri_interface, msg, OmniFeedback)() {
  return &::sri_interface::msg::rosidl_typesupport_introspection_cpp::OmniFeedback_message_type_support_handle;
}
