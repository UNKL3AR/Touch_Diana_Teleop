...
#ifndef SRI_INTERFACE__MSG__DETAIL__OMNI_FEEDBACK__FUNCTIONS_H_
#define SRI_INTERFACE__MSG__DETAIL__OMNI_FEEDBACK__FUNCTIONS_H_
 ...
 * calls
 * sri_interface__msg__OmniFeedback__init().
...
/**
 * It calls
 * sri_interface__msg__OmniFeedback__fini()
 ...
 * sri_interface__msg__OmniFeedback__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * sri_interface__msg__OmniFeedback__Sequence__fini()
 * on the array,
...
#endif  // SRI_INTERFACE__MSG__DETAIL__OMNI_FEEDBACK__FUNCTIONS_H_
